        ...
        <Card.Body>
          <Row className="row">
            <Col xl={8} lg={6} md={12} xs={12}>
              <div className="mb-2">
                ...
                <p>
                  ...
                  Next Payment: on{" "}
                  <span className="text-primary">$499.00 USD</span>
            ...
            <Col xl={4} lg={6} md={12} xs={12}>
              <div>
                <small className="text-muted">Yearly Payment</small>
                <h1 className="fw-bold text-primary">$499 USD</h1>
                <Link
                  href="#"
                  className="mb-3 text-muted text-primary-hover d-block"
                >
        ...
        <Card.Footer className="bg-white">
          <div className="d-md-flex justify-content-between align-items-center">
            ...
            <div className="text-center text-md-start">
              ...
              <Link href="#" className="btn btn-outline-white ms-2">
                Change Card
              </Link>
            </div>
          </div>
