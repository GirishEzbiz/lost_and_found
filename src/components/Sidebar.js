            ...
            <div className="dropdown">
              <div className="setting-page-full">
                <div className="setting-page-wrapper">
                  ...
                  <a href="currency.html" className="mt-8">
                    <div className="setting-deatils">
                      <div className="setting-icon">
                        <svg
                          width="24"
                  ...
                  <a href="about-us-screen.html" className="mt-8">
                    <div className="setting-deatils">
                      <div className="setting-icon">
                        <svg
                          width="24"
                  ...
                  <a href="policy-screen.html" className="mt-8">
                    <div className="setting-deatils">
                      <div className="setting-icon">
                        <svg
                          width="24"
                  ...
                  <a href="faq-screen.html" className="mt-8">
                    <div className="setting-deatils">
                      <div className="setting-icon">
                        <svg
                          width="24"
                  ...
                  <a href="feedback-screen.html" className="mt-8">
                    <div className="setting-deatils">
                      <div className="setting-icon">
                        <svg
                          width="24"
                  ...
                  <a href="complete-course-rating.html" className="mt-8">
                    <div className="setting-deatils">
                      <div className="setting-icon">
                        <svg
                          width="24"
                  ...
                  <div className="setting-border mt-8"></div>
                  <a href="mentor-screen.html" className="mt-8">
                    <div className="setting-deatils">
                      <div className="setting-icon">
                        <svg
                          width="24"
                  ...
                  <a href="onboarding-screen.html" className="mt-8">
                    <div className="setting-deatils">
                      <div className="setting-icon">
                        <svg
                          width="24"
