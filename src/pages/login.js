    ...
    <div className="container px-3">
      ...
      <form>
        <div className="mb-3">
          ...
          <p style={{ color: '#797979' }}>Enter the email you registered with.</p>
        ...
        <div className="text-end">
          <Link href="#" className="forgot-password ms-auto" style={{ color: "#242760" }}>
            Forgot Password
          </Link>
        </div>
        ...
        <button type="button" className="btn btn-google p-3 mt-4">
          <svg className='position-absolute left-0' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
